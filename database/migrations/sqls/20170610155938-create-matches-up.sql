CREATE TABLE IF NOT EXISTS matches (
	...
	user_1_id varchar(128) NOT NULL REFERENCES users(user_id),
	user_2_id varchar(128) NOT NULL REFERENCES users(user_id),
	winner_id varchar(128) REFERENCES users(user_id),
	loser_id varchar(128) REFERENCES users(user_id),
